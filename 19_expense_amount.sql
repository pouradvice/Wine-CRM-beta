-- 19_expense_amount.sql
-- Add expense_amount column to recaps table and update save_recap to store it.

-- Add expense_amount column
ALTER TABLE recaps ADD COLUMN IF NOT EXISTS expense_amount NUMERIC(10,2);

-- Update save_recap to store expense_amount
...
BEGIN
  ...
  -- Insert recap (includes occasion for Event type and expense_amount)
  INSERT INTO recaps (
    team_id,
    account_id,
    contact_id,
    ...
    NULLIF(p_recap->>'expense_amount', '')::NUMERIC,
