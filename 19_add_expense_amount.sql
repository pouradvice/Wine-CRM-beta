-- Add expense_amount column to recaps
ALTER TABLE recaps ADD COLUMN IF NOT EXISTS expense_amount numeric(10,2) NULL;

-- Update save_recap to persist expense_amount
